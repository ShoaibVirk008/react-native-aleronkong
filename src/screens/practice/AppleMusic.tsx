...
const snapPoints = [
  70,
  songCoverSizes[1] + songCoverTopPositions[1] + 15 + 24 + 10 + 30 + 28+20,
]
    ...
    return (
      <AnimatedView style={[styles.contentContainer]}>
        ...
        <AnimatedView style={{ opacity: animatedContentOpacity }}>
          ...
          <Text style={styles.songInfoText}>{`${song.artist} ⏤ ${song.album
            }`}</Text>
        </AnimatedView>
      </AnimatedView>
    )
        ...
        <AnimatedView style={styles.headerContainer}>
          ...
          >
            ...
            <TouchableOpacity style={styles.headerActionButton}>
              <Icon name="ios-play" type='ionicon' size={32} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.headerActionButton}>
              <Icon name="play-forward" type='ionicon' size={32} />
            </TouchableOpacity>
          </AnimatedBlurView>
        </AnimatedView>
      </TouchableWithoutFeedback>,
